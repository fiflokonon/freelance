...
<div class="site-wrap">
    ...
    <section class="section-hero home-section overlay inner-page bg-image"
                        ...
                        <div class="row">
                            <div class="col-md-12 popular-keywords">
                                ...
                                <ul class="keywords list-unstyled m-0 p-0">
                                    <li><a href="job-listings.html#" class>UI Designer</a></li>
                                    <li><a href="job-listings.html#" class>Python</a></li>
                                    <li><a href="job-listings.html#" class>Developer</a></li>
                                </ul>
                            </div>
                        </div>
                    </form>
        ...
        <a href="job-listings.html#next" class="scroll-button smoothscroll">
            ...
            <div class="row pagination-wrap">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="custom-pagination ml-auto">
                        <a href="job-listings.html#" class="prev">Prev</a>
                        <div class="d-inline-block">
                            <a href="job-listings.html#" class="active">1</a>
                            <a href="job-listings.html#">2</a>
                            <a href="job-listings.html#">3</a>
                            <a href="job-listings.html#">4</a>
                        </div>
                        <a href="job-listings.html#" class="next">Next</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-3 ml-auto">
                    <a href="job-listings.html#" class="btn btn-warning btn-block btn-lg">Sign Up</a>
                </div>
            </div>
        </div>
    </section>
