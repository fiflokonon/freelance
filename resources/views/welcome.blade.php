                    ...
                    <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
                        ...
                        <li class="has-children">
                            ...
                            <ul class="dropdown">
                                ...
                                <li><a href="{{ route('new_job') }}">Nouveau job</a></li>
                            </ul>
                        </li>
                        <li><a href="blog.html">Blog</a></li>
                        <li><a href="contact.html">Contact</a></li>
                        <li class="d-lg-none"><a href="{{ route('new_job') }}"><span class="mr-2">+</span> Nouveau job</a></li>
                        <li class="d-lg-none"><a href="{{ route('login') }}">Se connecter</a></li>
                    </ul>
                </nav>
                <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
                    <div class="ml-auto">
                        <a href="{{ route('new_job') }}" class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-add"></span>Post a Job</a>
                        <a href="{{ route('login') }}" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span
                                class="mr-2 icon-lock_outline"></span>Se connecter</a>
                    </div>
                    <a href="index.html#" class="site-menu-toggle js-menu-toggle d-inline-block d-xl-none mt-lg-2 ml-3"><span
                        ...
                        <div class="row">
                            <div class="col-md-12 popular-keywords">
                                ...
                                <ul class="keywords list-unstyled m-0 p-0">
                                    <li><a href="index.html#" class>UI Designer</a></li>
                                    <li><a href="index.html#" class>Python</a></li>
                                    <li><a href="index.html#" class>Developer</a></li>
                                </ul>
                            </div>
                        </div>
                    </form>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-3 ml-auto">
                    <a href="index.html#" class="btn btn-warning btn-block btn-lg">Sign Up</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-6 align-self-center text-center text-md-left mb-5 mb-md-0">
                    ...
                    <p class="mb-5 lead text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit tempora
                        adipisci impedit.</p>
                    <p class="mb-0">
                        <a href="index.html#" class="btn btn-dark btn-md px-4 border-width-2"><span
