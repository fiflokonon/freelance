...
<a href="{{ route('register') }}">Home</a> <span class="mx-2 slash">/</span>
...
<input type="text" id="last_name" name="last_name" class="form-control" placeholder="Votre Nom">
</div>
</div>
<div class="row form-group">
<div class="col-md-12 mb-3 mb-md-0">
<label class="text-black" for="first_name">Prénoms</label>
<input type="text" id="first_name" name="first_name" class="form-control" placeholder="Vos Prénoms">
</div>
</div>
<div class="row form-group">
<div class="col-md-12 mb-3 mb-md-0">
...
<input type="password" id="confirm-password" name="confirm-password" class="form-control" placeholder="Reconfirmez votre mot de passe">
</div>
</div>
<div class="row form-group">
    <div class="col-md-12 mb-3 mb-md-0">
    <label class="text-black" for="country">Pays</label>
    <input type="text" id="country" name="country" class="form-control" placeholder="Votre pays">
    </div>
    </div>
    <div class="row form-group">
    <div class="col-md-12 mb-3 mb-md-0">
    <label class="text-black" for="photo">Photo</label>
    <input type="file" id="photo" name="photo" class="form-control" placeholder="Choisir une image ">
    </div>
    </div>
    <div class="row form-group">
    <div class="col-md-12 mb-3 mb-md-0">
...
<div class="row form-group">
<div class="col-md-12">
<input type="submit" value="{{ __("S'inscrire") }}" class="btn px-4 btn-primary text-white">
</div>
</div>
</form>
</div>
